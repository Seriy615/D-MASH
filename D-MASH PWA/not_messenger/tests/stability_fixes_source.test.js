...
assert.match(release, /20260905\.52/, "release 52 is visible");
...
assert.match(release, /acceptance_v52\.js/, "v52 final secure-registry runtime is loaded");
...
console.log("v52 browser acceptance source regression: all assertions passed");
