...
const source = fs.readFileSync(require.resolve("../js/runtime_fixes.js"), "utf8");
...
assert.match(source, /try \{ output = this\._prfResult\(credential\); \}/);
assert.match(source, /output = await this\._getPrfAssertion\(credentialId, salt\)/);
