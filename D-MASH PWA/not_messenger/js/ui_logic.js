...
const sys = {
    ...
    async loadAllLibs() {
        try {
            window.Module = { wasmBinaryFile: 'https://unpkg.com/argon2-browser@1.18.0/dist/argon2.wasm' };
            const ver = Date.now();
            await Promise.all([
                this.loadScript('https://unpkg.com/argon2-browser@1.18.0/dist/argon2-bundled.min.js'),
                this.loadScript('https://unpkg.com/tweetnacl@1.0.3/nacl-fast.min.js'),
                this.loadScript('https://unpkg.com/tweetnacl-util@0.15.1/nacl-util.min.js'),
                this.loadScript('https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js'),
                this.loadScript('https://unpkg.com/html5-qrcode'),
                this.loadScript(`js/storage.js?v=${ver}`),
                this.loadScript(`js/core_engine.js?v=${ver}`)
            ]);
            let tries = 0;
            while (typeof window.argon2 === 'undefined' && tries < 60) {
